#!/usr/bin/env python3
"""YouTube-first orchestration with bounded Pixabay fallback for v1.4.1."""
...
SCHEMA_VERSION = "1.4.1-youtube-first.1"
...
def run_youtube_first_pipeline(
    ...
    manifest = apply_usage_policy({
        ...
        "status": status, "theme": theme, "requested": {"desired_count": desired_count, "aspect_ratio": aspect_ratio, "candidate_pool_multiplier": candidate_pool_multiplier, "priority_queries": list(priority_queries), "source_windows": (youtube.get("requested") or {}).get("source_windows", source_windows or {})},
